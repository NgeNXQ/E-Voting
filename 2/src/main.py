...
if __name__ == "__main__":
    ...
    sgined_vote_pool = commission.process(voter_0, vote_pools_cluster)
    final_vote = voter_0.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    ...
    sgined_vote_pool = commission.process(voter_2, vote_pools_cluster)
    final_vote = voter_2.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    commission.register_final_vote(final_vote)
    ...
    sgined_vote_pool = commission.process(voter_3, vote_pools_cluster)
    final_vote = voter_3.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    commission.register_final_vote(final_vote)
    ...
    sgined_vote_pool = commission.process(voter_4, vote_pools_cluster)
    final_vote = voter_4.process_commission_response(sgined_vote_pool, candidate_2, commission.get_public_key())
    commission.register_final_vote(final_vote)
    ...
    vote_pools_cluster = voter_4.create_vote_pools_cluster(candidates, CommissionController.VOTE_POOLS_CLUSTER_SIZE)
    sgined_vote_pool = commission.process(voter_4, vote_pools_cluster)
    final_vote = voter_4.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    commission.register_final_vote(final_vote)
    ...
    # voter6 Invlalid cluster
    print("voter #6 ", end = '')
    vote_pools_cluster = voter_6.create_vote_pools_cluster(candidates, 1)
    sgined_vote_pool = commission.process(voter_6, vote_pools_cluster)
    final_vote = voter_6.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    commission.register_final_vote(final_vote)

    # voter9 OK
    print("voter #9 ", end = '')
    vote_pools_cluster = voter_7.create_vote_pools_cluster(candidates, CommissionController.VOTE_POOLS_CLUSTER_SIZE)
    sgined_vote_pool = commission.process(voter_7, vote_pools_cluster)
    final_vote = voter_7.process_commission_response(sgined_vote_pool, candidate_1, commission.get_public_key())
    commission.register_final_vote(final_vote)
